...
public class CLI {
  ...
  public void run() throws MalformedURLException {
    ...
    QName qnameComputer = new QName("http://impl.web.cdb.excilys.com/", "ComputerWebImplService");
    ...
    QName qnameCompany = new QName("http://impl.web.cdb.excilys.com/", "CompanyWebImplService");
  ...
  public ComputerDTO setComputerData() {
    ...
    System.out
        .println("Please enter the date of introduction, format yyyy-MM-dd HH:mm (null if unknown)");
    String dateIntroduced = sc.nextLine();
    System.out
        .println("Please enter the date of discontinuation, format yyyy-MM-dd HH:mm (null if unknown)");
